    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="frontend-navbar-collapse">
            ...
            <ul class="nav navbar-nav hide">
                ...
                <li class="hide">{!! link_to_route('frontend.macros', trans('navs.frontend.macros')) !!}</li>
            </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @if (Auth::guest())
                    <li>{!! link_to('admin/login', trans('navs.frontend.login')) !!}</li>
                    <li class="hide">{!! link_to('register', trans('navs.frontend.register')) !!}</li>
                @else
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
