        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <div class="form-group">
                    {!! Form::label('First name', trans('validation.attributes.backend.access.users.firstname'), ['class' => 'col-lg-2 control-label']) !!}
                    <div class="col-lg-10">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {!! Form::text('surname', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.access.users.surname')]) !!}
                    </div>
                </div><!--form control-->
                ...
                <div class="form-group">
                    {!! Form::label('board number', trans('validation.attributes.backend.access.users.board'), ['class' => 'col-lg-2 control-label']) !!}
                    <div class="col-lg-10">
                        {!! Form::text('board_number', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.access.users.board')]) !!}
                    </div>
                </div><!--form control-->
