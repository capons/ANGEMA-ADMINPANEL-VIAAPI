...
Route::group([
    ...
    Route::group(['namespace' => 'User'], function() {
        /**
         * Users RESTFul controller UserController
         */
        Route::resource('users', 'UserController', ['except' => ['show']]);  // user restFull controller
        /* ./RESTFul controller UserController*/
        /**
         * Create users CSV file
         */
        Route::get('users/csv', 'UserController@indexCsv')->name('admin.access.users.csv'); //
        Route::post('users/csv', 'UserController@getCsv')->name('admin.access.users.csv'); //save users CSV
        /** ./users CSV file**/
